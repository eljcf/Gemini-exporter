...
### 方法一：通过 Chrome 应用商店安装 

> 🚧 在chrome应用商店搜索Gemini-exporter即可下载/点击下方连接下载

https://chromewebstore.google.com/detail/gemini-exporter/djeafpklmikmngppfngljfbnnndcbeai?hl=zh-CN&utm_source=ext_sidebar
